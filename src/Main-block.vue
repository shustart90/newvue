<template>
  <div id="main">
    <section class="text-block">
      <h1 class="head text-block__head">Наши топ-блогеры</h1>
      <p class="par text-block__par">Лучше специалисты в своем деле,<br>
        средний опыт работы в профессии - 27 лет</p>
    </section>
    <MainSlider :cardsCount="cardsCount"></MainSlider>
...
export default {
  ...
  data () {
    return {
      ...
      currentTextBlock: "",
      firstUser: "", //первый активный разработчикотступ для блока со слайдером
  ...
  methods: {
    clickEffect (event) { // выделение карточки с разработчиком
      ...
      childrenElems[1].classList.add("focused-text"); //заголовок цитаты
      childrenElems[2].classList.add("focused-text"); //текст цитаты
